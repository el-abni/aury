...
### Resultado
A linha **1.4.1** fecha a fase de refinamento conversacional da série 1.4, mantendo compatibilidade com a base da **1.4.0** e preparando o terreno para a **1.5.0**.
